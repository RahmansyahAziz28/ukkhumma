        ...
        <div class="sidebar-menu p-3">
            <ul class="nav flex-column">
                ...
                @if (Auth::user()->hak_akses == 'member')
                  <li class="nav-item mb-2">
                    <a href="{{ route('history') }}" class="nav-link text-white {{ Request::is('kategori') ? 'active' : '' }}">
                        <i class="fas fa-tags me-2"></i> History
                    </a>
                </li>
                @endif
                @if (Auth::user()->hak_akses != 'member')
                ...
                @if (Auth::user()->hak_akses == 'kasir' || Auth::user()->hak_akses == 'pimpinan' )
                <li class="nav-item mb-2">
