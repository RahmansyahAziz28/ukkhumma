                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('detail_barang') is-invalid @enderror"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <input type="number" step="any" class="form-control @error('berat') is-invalid @enderror"
